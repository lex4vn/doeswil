...
class Aboutprogram extends MY_Controller {
...
*/
	...
	public function index()
	{
		...
		"select * from ".$this->db->dbprefix('pages')." where slug='aboutprogram' and lang='".$language."'"
		);
		$this->data['term_content'] 	= $term_content;
		$this->data['active_menu'] 		= 'aboutus';
		$this->data['content'] 			= 'general/aboutprogram';
